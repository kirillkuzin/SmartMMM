...
contract SmartMMM is Ownable
{
    ...
    function getPercents(uint balance) public pure returns(uint depositPercent, uint referrerLevelOnePercent, uint referrerLevelTwoPercent, uint cashBackPercent, uint techSupportPercent, uint adsSupportPercent)
    {
        ...
        else if(balance >= 10000 ether && balance < 20000 ether) return (138888888889, 50, 10, 20, 25, 50);
        ...
        else if(balance >= 50000 ether && balance < 60000 ether) return (416666666667, 10, 5, 3, 15, 30);
        else if(balance >= 60000 ether && balance < 70000 ether) return (277777777778, 5, 3, 3, 10, 20);
        else if(balance >= 70000 ether && balance < 100000 ether) return (138888888889, 3, 2, 2, 10, 20);
        else return (6944444444, 2, 2, 1, 10, 20);
    }
